                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <select value={email} onChange={(e) => setEmail(e.target.value)} className="app-select pl-10 mt-1 w-full text-zinc-900 dark:text-zinc-200 text-sm placeholder-zinc-400 dark:placeholder-zinc-500 py-2 focus:outline-none focus:border-indigo-500" required >
                    ...
                    <div className="flex justify-end gap-3 pt-2">
                        ...
                        <button type="submit" disabled={isAdding || !currentWorkspace} className="app-btn-primary px-5 py-2 text-sm disabled:opacity-50" >
