    ...
    return (
        <div className="flex flex-col-reverse lg:flex-row gap-6 sm:p-4 text-gray-900 dark:text-zinc-100 max-w-6xl mx-auto">
            ...
            <div className="w-full lg:w-2/3">
                <div className="p-5 rounded-md app-surface app-card flex flex-col lg:h-[80vh]">
                        ...
                        {comments.length > 0 ? (
                            <div className="flex flex-col gap-4 mb-6 mr-2">
                                {comments.map((comment) => (
                                    <div key={comment.id} className={`sm:max-w-4/5 app-surface border p-3 rounded-md ${comment.user.id === user?.id ? "ml-auto" : "mr-auto"}`} >
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-end gap-3">
                        <textarea
                            ...
                            className="app-input w-full rounded-md p-2 text-sm text-gray-900 dark:text-zinc-200 resize-none focus:outline-none focus:ring-1 focus:ring-indigo-600"
                            rows={3}
                        />
                        <button onClick={handleAddComment} className="app-btn-primary text-sm px-5 py-2 rounded" >
                            Post
                        </button>
                    </div>
                </div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-6">
                {/* Task Info */}
                <div className="p-5 rounded-md app-surface app-card border">
                    <div className="mb-3">
                ...
                {/* Project Info */}
                {project && (
                    <div className="p-4 rounded-md app-surface app-card text-zinc-700 dark:text-zinc-200 border">
